...
struct DocGiaQuaHan { // struct phu de luu thong tin doc gia va so ngay qua han, de sap xep va liet ke.làm như này sẽ giúp chúng ta dễ dàng quản lý và hiển thị thông tin về các độc giả có sách quá hạn, đồng thời cho phép chúng ta sắp xếp danh sách này theo số ngày quá hạn hoặc theo mã thẻ độc giả.
    DocGia* dg;
    int soNgayQuaHan;
};
