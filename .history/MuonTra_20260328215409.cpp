...
bool muonSach(TREE_DocGia root, ListDauSach &ds, int maThe, const char* maSach, Ngay ngayMuon) {
    ...
    //strcpy(muonTra->maSach, maSach); De quyet dinh khong su dung strcpy de copy maSach vao muonTra->maSach vi strcpy khong an toan khi do dai chuoi nguon vuot qua kich thuoc cua chu
