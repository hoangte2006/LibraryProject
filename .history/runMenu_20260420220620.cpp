...
const char* chonSachDangMuonUI(DocGia* docGia, ListDauSach& ds) {
    ...
    while (true) {
        ...
        cout << "Doc gia: " << docGia->ho << " " << docGia->ten << "\n\n";
        ...
        if (status == INPUT_UP) currentField = (currentField - 1 + 6) % 6;
            ...
            if (currentField >= 6) {
                ...
                if (isThemMoi) {
                    ...
                    strcpy_s(p->ISBN, isbn); strcpy_s(p->tenSach, tenSach); strcpy_s(p->tacGia, tacGia); strcpy_s(p->theLoai, theLoai);
                    ...
                    ds.n--;
                    strcpy_s(dsPtr->tenSach, tenSach); strcpy_s(dsPtr->tacGia, tacGia); strcpy_s(dsPtr->theLoai, theLoai);
        ...
        if (status == INPUT_UP) currentField = (currentField - 1 + 3) % 3;
            ...
            if (currentField >= 3) { // Reached end of form, process save
                ...
                if (isThemMoi) {
                    ...
                    strcpy_s(newDg->giotinh, (gioiTinh == 1 ? "NAM" : "NU"));
                    ...
                    strcpy_s(dg->ho, ho);
                    strcpy_s(dg->ten, ten);
                    strcpy_s(dg->giotinh, (gioiTinh == 1 ? "NAM" : "NU"));
        ...
        if (dg) {
            ...
            if (chonPhai == 0) { // Muon sach
                if (dg->trangThaiThe == 0) {
                    ...
                    cout << "\nAn phim bat ky de tiep tuc chon sach muon...";
                    _getch();
                ...
                if (dg->soSachDangMuon == 0) { 
                    ...
                    cout << "\nAn phim bat ky de tiep tuc chon sach tra...";
                    _getch();
                ...
                if (dg->soSachDangMuon == 0) { 
                    ...
                    cout << "\nAn phim bat ky de tiep tuc bao mat sach...";
                    _getch();
...
void thongKeUI(QuanLyDocGia& qlDocGia, ListDauSach& ds) {
    ...
    int indexPhai = 0;
    const char* menuThongKe[] = { 
        "1. Danh sach doc gia qua han", 
        "2. Top 10 sach muon nhieu nhat", 
        "3. Thong ke so luong theo the loai", 
        "0. Quay lai" 
    };
    int luaChon = 0;
    ...
    while (true) {
        ...
        cout << "\n======================== MENU THONG KE ========================\n\n";
        resetColor();
        cout << "   Su dung Phim mui ten Len/Xuong de chon, Enter de xac nhan:\n\n";

        int chonPhai = chonMenu(subThongKe, 4, 35, 7, indexPhai);
        if (chonPhai == 3 || chonPhai == -1) return;
        int chon = chonMenu(menuThongKe, 4, 5, 5, luaChon);
        if (chon == 3 || chon == -1) return;
        ...
        if (chon == 0) lietKeDocGiaQuaHan(qlDocGia);
        else if (chon == 1) inTop10SachMuonNhieu(ds);
        else if (chon == 2) thongKeSoLuongTheoTheLoai(ds);
        
        cout << "\n\nNhan phim bat ky de quay lai...";
        cout << "\n\nNhan phim bat ky de quay lai menu Thong ke...";
        _getch();
        showCursor(false);
    }
}
