...
void traCuuTheoTen(const ListDauSach &ds, const char* tenSach) { // ham tra cuu dau sach theo ten sach, su dung binary search de tim kiem nhanh hon, nen can dam bao rang danh sach dau sach da duoc sap xep theo ten sach.
    if (ds.n == 0) {
