...
// Nói ngắn ngọn hàm này là để cập nhật trường tenSachSearch của DauSach, trường này sẽ chứa phiên bản đã được chuẩn hóa (chuyển sang chữ thường) của tenSach để phục vụ cho việc tra cứu nhanh khi tìm kiếm theo tên sách. Khi thêm mới hoặc chỉnh sửa tên sách, chúng ta sẽ gọi hàm này để đảm bảo rằng tenSachSearch luôn được cập nhật đúng với tenSach nhưng ở dạng chữ thường, giúp cho việc tìm kiếm theo tên sách trở nên dễ dàng và hiệu quả hơn.
