...
time_t chuyenNgaySangTimeT(const Ngay& ngay) {
    struct tm tmNgay = {0}; // khoi tao struct tmNgay voi tat ca cac truong duoc dat ve 0, dieu nay giup dam bao tinh an toan khi su dung sau nay, tranh viec cac truong khong duoc gan gia tri co gia tri rac roi khong mong muon.
