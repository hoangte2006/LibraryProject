...
bool dangMuonSach(const DocGia* docGia, const char* maSach) {
    ...
    // check tung muonTra trong danh sach muon tra cua doc gia do, neu tim thay muonTra nao co maSach trung khop va trangThai == 0 (dang muon), thi tra ve true de biet rang doc gia do dang muon cuon sach co maSach do. Neu da check het danh sach muon tra ma khong tim thay muonTra nao co maSach trung khop va trangThai == 0 (dang muon), thi tra ve false de biet rang doc gia do khong dang muon cuon sach co maSach do.
    while (temp != nullptr) {
