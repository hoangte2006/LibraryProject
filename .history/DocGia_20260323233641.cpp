    ...
    if (maThe < root->maThe) {
        ...
        // quy tat don gian: chon X nho nhat trong nhanh phai node 3 nhung lon lon node 3.
            ...
            if (replacementParent == root) {
                replacementParent->pRight = replacement->pRight; // neu node thay the la con phai truc tiep cua node can xoa, thi cap nhat con tro pRight cua node thay the de tro den con phai cua node thay the, de duy tri cau truc cay sau khi xoa.
            }
    }
