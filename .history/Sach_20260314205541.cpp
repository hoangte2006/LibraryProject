...
void themDauSach(ListDauSach &ds) {    
    ...
    p->sttXoa.top = -1; // khoi tao stack sttXoa rong, top = -1 de bieu thi stack rong.
     ...
     // chen vao vi tri pos, cac node tu pos tro ve sau se duoc dich sang phai 1 don vi, va node moi se duoc chen vao vi tri pos.
     // truong hop 1: neu ten sach can them nho hon tat ca ten sach trong danh sach, thi pos = 0, node moi se duoc chen vao dau danh sach.
     // truong hop 2: neu ten sach can them lon hon tat ca ten sach trong danh sach, thi pos = ds.n, node moi se duoc chen vao cuoi danh sach.
     // truong hop 3: neu ten sach can them nam giua danh sach, thi pos la vi tri ma ten sach can them nho hon ten sach tai pos, va lon hon ten sach tai pos - 1, node moi se duoc chen vao giua danh sach.
