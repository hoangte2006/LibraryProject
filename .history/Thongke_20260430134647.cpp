...
void inTop10SachMuonNhieu(const ListDauSach &ds) {
    ...
    for (int i = 0; i < limit; i++) {
        ...
        // Bo qua va khong in nhung sach co luot muon = 0
        if (arr[0]->soLuotMuon == 0) {
            if (i == 0) cout << " │ " << left << setw(62) << "Chua co sach nao dang duoc muon!" << " │\n";
            if (i == 0) cout << " │ " << left << setw(62) << "Chua co sach nao duoc muon!" << " │\n";
            break;
        }
