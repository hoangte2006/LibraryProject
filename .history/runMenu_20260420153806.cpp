...
void quanLySachUI(ListDauSach& ds) {
    ...
    while (true) {
        ...
        if (key == 0 || key == 224) {
            ...
            cout << "\n\n(T)hem cuon sach moi | ESC: Quay lai\n";
            int k = _getch();
    ...
    while (isRunning) {
        ...
        while (inSub) {
                ...
                if (dg) {
                    ...
                    if (chonPhai == 0) { // Muon sach
                        if (dg->trangThaiThe == 0) cout << "The dang bi KHOA!\n";
                            ...
                            char ms[25];
                            cout << endl;
                            if (nhapMa("Nhap MA SACH (VD: ISBN_0001): ", ms, 25)) {
                                muonSach(dg, ds, ms);
                            } else {
                        ...
                        if (dg->soSachDangMuon == 0) cout << "Doc gia nay dau co muon sach dau ma tra ní!\n";
                            ...
                            char ms[25];
                            cout << endl;
                            if (nhapMa("Nhap ma sach can TRA: ", ms, 25)) {
                        ...
                        char ms[25];
                        cout << endl;
                        if (nhapMa("Nhap ma sach bao MAT: ", ms, 25)) {
                            baoMatSach(dg, ds, ms);
                        } else {
                            cout << "Da huy bao mat.\n";
                        }
            ...
            if (inSub) { // Chi hien thi khi van con o menu con
                ...
                // veKhungGiaoDien(); // Xoa dong nay
                continue; // Them dong nay de nhay ve dau vong lap, tu dong ve lai khung
            }
        }
    }
}