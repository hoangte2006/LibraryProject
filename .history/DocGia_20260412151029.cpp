...
int taoMaTheMoi(TREE_DocGia root) {
    ...
    // Thu random 100 lan (o muc binh thuong random chung 1-2 lan la duoc)
    ...
    // Fallback: Quet tuan tu neu rand() ra toan ma bi trung (khi thu vien gan dat 9000 doc gia)
    ...
    return -1; // Truong hop hi huu: full 9000 ma the
}
