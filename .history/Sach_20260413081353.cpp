...
// hàm này sẽ trả về vị trí mà tại đó tên sách mới nên được chèn vào để duy trì thứ tự tăng dần theo tên sách trong mảng ds.nodes. Nếu tên sách đã tồn tại, nó sẽ trả về vị trí của tên sách đó.
