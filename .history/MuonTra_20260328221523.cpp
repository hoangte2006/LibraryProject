...
int tinhSoNgay(const Ngay& ngayMuon, const Ngay& ngayHienTai) {
    ...
    double seconds = difftime(timeHienTai, timeMuon); // tinh so giay giua ngay hien tai va ngay muon, neu timeHienTai lon hon timeMuon thi seconds se la so duong, neu timeHienTai nho hon timeMuon thi seconds se la so am, neu bang nhau thi seconds se la 0.
}
