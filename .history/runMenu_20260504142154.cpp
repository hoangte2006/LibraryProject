...
void runMenu() {
    ...
    khoiTaoKhoMaThe();
    suaChuaDuLieu(qlDocGia, ds); // Tu dong quet va khop loi du lieu giua 2 file
    // suaChuaDuLieu(qlDocGia, ds); // An di theo loi dan cua thay (Doc nguyen trang thai tu file txt)
