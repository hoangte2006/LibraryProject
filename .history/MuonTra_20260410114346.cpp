...
bool baoMatSach(TREE_DocGia root, ListDauSach &ds, int maThe, const char* maSach)
{
    ...
    if (docGia == nullptr) {
        ...
        return false;
    // Da xoa dong if (!dangMuonSach) de khong duyet O(M) bi trung lan nua
    ...
    // Neu code chay xuong toi day tuc la di het danh sach ma khong thay
    cout << "Doc gia khong muon sach nay hoac khong tim thay phieu muon!
