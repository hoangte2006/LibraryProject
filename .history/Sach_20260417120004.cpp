...
void themDauSach(ListDauSach &ds) {    
    ...
    do {
        ...
        if (strlen(p->tenSach) == 0) cout << "Ten sach khong duoc de trong!\n";
    } while (strlen(p->tenSach) == 0);
    ...
    do {
        ...
        if (strlen(p->tacGia) == 0) cout << "Tac gia khong duoc de trong!\n";
    } while (strlen(p->tacGia) == 0);

    do {
        cout << "Nhap the loai: ";
        cin.getline(p->theLoai, 30);
        if (strlen(p->theLoai) == 0) cout << "The loai khong duoc de trong!\n";
    } while (strlen(p->theLoai) == 0);
...
void themCuonSach(DauSach* dauSach) {
    ...
    do {
        ...
        if (strlen(newSach->viTri) == 0) cout << "Vi tri khong duoc de trong!\n";
    } while (strlen(newSach->viTri) == 0);
...
void hieuChinhDauSach(ListDauSach &ds) {
    ...
    do {
        ...
        if (strlen(tenMoi) == 0) cout << "Ten sach khong duoc de trong!\n";
    } while (strlen(tenMoi) == 0);

    do {
        cout << "Nhap tac gia moi: ";
        cin.getline(d->tacGia, 50);
        if (strlen(d->tacGia) == 0) cout << "Tac gia khong duoc de trong!\n";
    } while (strlen(d->tacGia) == 0);

    do {
        cout << "Nhap the loai moi: ";
        cin.getline(d->theLoai, 30);
        if (strlen(d->theLoai) == 0) cout << "The loai khong duoc de trong!\n";
    } while (strlen(d->theLoai) == 0);
