...
void khoaMoThe(TREE_DocGia root, int maThe)
{
    ...
    dg->trangThaiThe = (dg->trangThaiThe == 1) ? 0 : 1; // neu the dang hoat dong (trangThaiThe == 1) thi khoa the (trangThaiThe = 0), nguoc lai neu the da bi khoa (trangThaiThe == 0) thi mo khoa the (trangThaiThe = 1).
