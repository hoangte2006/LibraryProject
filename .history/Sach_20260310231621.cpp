...
void themCuonSach(DauSach* dauSach) {
    ...
    int stt = laySoThuTuLonNhat(dauSach->dsSach) + 1; // lấy số thứ tự lớn nhất hiện có trong danh sách sách của đầu sách và cộng thêm 1 để tạo mã sách mới theo định dạng "ISBN_STT".
