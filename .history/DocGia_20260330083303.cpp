...
// sau do sap xep lai mang sao cho cac phan tu nho hon pivot nam ben trai va cac phan tu lon hon pivot nam ben phai
...
int partition(DocGia* arr[], int left, int right) {
    ...
    int i = left - 1;   
    // dong for nay se duyet tu left den right-1, neu phan tu nho hon pivot thi tang i len 1 va doi cho phan tu tai i voi phan tu tai j, sau khi ket thuc dong for thi cac phan tu nho hon pivot se nam ben trai chi so i, va cac phan tu lon hon pivot se nam ben phai chi so i.
