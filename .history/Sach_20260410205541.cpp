...
// hàm chuyển chuỗi thành chữ thường để hỗ trợ tìm kiếm nhanh hơn khi đã có trường tenSachSearch đã được chuẩn hóa sẵn, tránh việc phải chuyển đổi mỗi lần tìm kiếm, giúp tăng hiệu suất tìm kiếm khi có nhiều đầu sách trong hệ thống.
