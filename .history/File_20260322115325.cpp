...
//////////////////////////////////////////////////////////
// tai sao phải làm việc này: sau khi load dữ liệu từ file, chúng ta cần đồng bộ hóa thông tin về trạng thái của các cuốn sách trong hệ thống. Khi một cuốn sách đang được mượn (trạng thái 0), chúng ta cần cập nhật trạng thái của cuốn sách đó sang đã mượn (trạng thái 1) trong danh sách đầu sách để đảm bảo rằng thông tin về trạng thái của sách trong hệ thống luôn chính xác sau khi load dữ liệu từ file. Việc này giúp tránh những lỗi liên quan đến việc hiển thị sai trạng thái của sách hoặc cho phép mượn những cuốn sách đã được mượn mà không được cập nhật trạng thái đúng cách.
