...
#define MIN_MA_THE 10000
#define MAX_MA_THE 99999
#define SO_LUONG_MA 90000
...
struct DocGia {
    ...
    int soSachDangMuon = 0; // Tối ưu O(1) để kiểm tra tối đa 3 cuốn
...
struct QuanLyDocGia {
    ...
    int soLuongDocGia = 0; // toi uu thanh O(1), khong dung count
};
