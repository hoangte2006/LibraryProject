...
// Ham chuyen chuoi sang chu thuong de tra cuu nhanh hon khi tim kiem theo ten sach, vi khi tim kiem theo ten sach thi nguoi dung
static void capNhatTenSachSearch(DauSach* dauSach) {
    ...
    // HÀM TRẢ VỀ LÀ CHÍNH XÁC TÊN SÁCH ĐƯỢC CHUYỂN THÀNH CHỮ THƯỜNG VÀ LƯU TRONG TRƯỜNG tenSachSearch CỦA CẤU TRÚC DauSach, GIÚP CHO VIỆC TRA CỨU THEO TÊN SÁCH TRỞ NÊN NHANH HƠN VÌ KHÔNG CẦN PHẢI CHUYỂN ĐỔI TÊN SÁCH THÀNH CHỮ THƯỜNG MỖI LẦN KHI TRA CỨU, MÀ CÓ THỂ SO SÁNH TRỰC TIẾP VỚI tenSachSearch ĐÃ ĐƯỢC CHUYỂN SANG CHỮ THƯỜNG TỪ TRƯỚC.                       
}
