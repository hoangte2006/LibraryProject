...
{
    if (dauSach->sttXoa.top >= 0) // tai su dung lai so thu tu da bi xoa de tao maSach cho cuon sach moi, giup cho viec quan ly maSach cua cac cuon sach trong danh sach sach cua dau sach do duoc don gian va hieu qua hon, tranh viec maSach cua cuon sach moi bi lon len lien tuc khi them cuon sach moi sau khi da xoa nhieu cuon sach, dieu nay khong chi giup cho viec quan ly maSach duoc don gian hon ma con giup cho viec theo doi cac cuon sach da bi xoa de sau nay co the xem lai lich su xoa sach neu can thiet.
