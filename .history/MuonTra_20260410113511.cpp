...
bool muonSach(TREE_DocGia root, ListDauSach &ds, int maThe, const char* maSach) {
    ...
    // --- TIM SACH TRUOC: Fail-fast, nhap sai maSach thi bao loi ngay lap tuc ---
    // tim cuon sach theo maSach, va cung luc tim duoc dau sach chua cuon sach do de sau nay tang luot muon.
