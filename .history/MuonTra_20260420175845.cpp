...
bool traSach(DocGia* docGia, ListDauSach &ds, const char* maSach, Ngay ngayTra) {
    ...
    bool vanConLoi = false; // Kiem tra xem sau khi tra sach nay, con muon tra nao khac van con loi (qua han hoac mat) hay khong, de quyet dinh co can mo khoa the cho doc gia hay khong
