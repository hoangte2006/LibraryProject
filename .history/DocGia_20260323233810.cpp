    ...
    if (maThe < root->maThe) {
        ...
        // quy tat don gian: chon X nho nhat trong nhanh phai node 3 nhung lon lon node 3.
            ...
            if (replacementParent == root) {
                replacementParent->pRight = replacement->pRight; 
            } else {
            ...
            root = replacement; // dat con tro root tro den node thay the de duy tri cau truc cay sau khi da xoa node goc ban dau.
            return true; // tra ve true de biet rang da xoa doc gia thanh cong
    }
