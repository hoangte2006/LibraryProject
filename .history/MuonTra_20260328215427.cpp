...
bool muonSach(TREE_DocGia root, ListDauSach &ds, int maThe, const char* maSach, Ngay ngayMuon) {
    ...
    //strcpy(muonTra->maSach, maSach); De an toan hon khi copy maSach vao muonTra->maSach, tranh truong hop maSach co do dai vuot qua kich thuoc cua muonTra->maSach (25), neu do dai vuot qua thi strncpy se cat bo phan vuot qua va khong copy vao muonTra->maSach, de tranh loi ghi de bo nho va cac van de lien quan den tinh an toan khi su dung sau nay. Ham strncpy se copy toi da sizeof(muonTra->maSach)-1 ky tu tu maSach vao muonTra->maSach, va sau do gan ky tu ket thuc chuoi '\0' o cuoi de dam bao tinh an toan khi su dung sau nay.
