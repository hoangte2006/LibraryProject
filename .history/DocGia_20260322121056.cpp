...
void khoaMoThe(TREE_DocGia root, int maThe)
{
    ...
    docgia->trangThaiThe = (docgia->trangThaiThe == 1) ? 0 : 1; // neu the dang hoat dong (trangThaiThe == 1) thi khoa the (trangThaiThe = 0), nguoc lai neu the da bi khoa (trangThaiThe == 0) thi mo khoa the (trangThaiThe = 1), nen su dung toan tu ? : de chuyen doi trang thai cua the giua hoat dong va khoa khi nguoi dung chon chuc nang khoa mo the.
