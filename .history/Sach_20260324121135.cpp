...
// Ham mktime se chuyen doi struct tm (chua thong tin ve ngay thang nam) sang dang time_t, va chung ta co the su dung ket qua tra ve tu ham mktime de so sanh ngay thang nam, va tinh so ngay giua hai ngay thang nam khi can thiet.
