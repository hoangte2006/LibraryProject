...
bool xoaDocGia(TREE_DocGia &root, int maThe) {
    ...
    if (maThe < root->maThe) {
        ...
        // quy tat don gian: chon X nho nhat trong nhanh phai node 3 nhung lon lon node 3.
            ...
            DocGia* replacementParent = root; // luu dia chi cua node can xoa vao con tro replacementParent de sau khi tim duoc node thay the, ta se can den dia chi cua node can xoa de cap nhat lai cac con tro trong cay sau khi thay the.
        }
    }
