...
bool traSach(TREE_DocGia root, ListDauSach &ds, int maThe, const char* maSach, Ngay ngayTra) {
    ...
    if (strcmp(muonTra->maSach, maSach) == 0 && (muonTra->trangThai )) { // cho phep tra sach da bi mat (trangThai == 2) de cap nhat lai trang thai sach va muonTra, giup cho viec quan ly sach bi mat duoc hieu qua hon, va cung la de dam bao tinh chinh xac cua thong tin muon tra trong he thong quan ly thu vien.
