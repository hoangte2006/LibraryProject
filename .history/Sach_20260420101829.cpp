...
static void capNhatTacGiaSearch(DauSach* dauSach) {
    if (dauSach == nullptr) return;
...
void themDauSach(ListDauSach &ds) {    
    ...
    if (!nhapMa("Nhap ISBN: ", p->ISBN, 20)) {
        cout << "Da huy them dau sach.\n";
        delete p;
        return;
    }
    chuanHoaISBN(p->ISBN);
    ...
    if (!nhapTen("Nhap ten sach: ", p->tenSach, 100)) {
        cout << "Da huy them dau sach.\n";
        delete p;
        return;
    }
    ...
    if (!nhapTen("Nhap tac gia: ", p->tacGia, 50)) {
        cout << "Da huy them dau sach.\n";
        delete p;
        return;
    }
    ...
    if (!nhapTen("Nhap the loai: ", p->theLoai, 30)) {
        cout << "Da huy them dau sach.\n";
        delete p;
        return;
    }
...
void hieuChinhDauSach(ListDauSach &ds) {
    char isbn[20];
    if (!nhapMa("Nhap ISBN can sua: ", isbn, 20)) {
        cout << "Da huy hieu chinh.\n";
        return;
    }
    chuanHoaISBN(isbn);
    ...
    char tenMoi[100];
    if (!nhapTen("Nhap ten sach moi: ", tenMoi, 100)) {
        cout << "Da huy hieu chinh.\n";
        return;
    }
    if (!nhapTen("Nhap tac gia moi: ", d->tacGia, 50)) {
    char tacGiaMoi[51];
    if (!nhapTen("Nhap tac gia moi: ", tacGiaMoi, 50, d->tacGia)) {
        cout << "Da huy hieu chinh.\n";
        return;
    }
    if (!nhapTen("Nhap the loai moi: ", d->theLoai, 30)) {
    char theLoaiMoi[31];
    if (!nhapTen("Nhap the loai moi: ", theLoaiMoi, 30, d->theLoai)) {
        cout << "Da huy hieu chinh.\n";
        return;
    }
    ...
    strcpy(d->tacGia, tacGiaMoi);
    strcpy(d->theLoai, theLoaiMoi);
    capNhatTenSachSearch(d);
    capNhatTacGiaSearch(d);
...
void xoaDauSachUI(ListDauSach &ds) {
    char isbn[20];
    if (!nhapMa("Nhap ISBN can xoa: ", isbn, 20)) {
        cout << "Da huy xoa.\n";
        return;
    }
    chuanHoaISBN(isbn);
