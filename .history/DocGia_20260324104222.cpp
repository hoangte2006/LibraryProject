...
// Ham tra ve con tro den doc gia co ma the giong 
DocGia* timDocGia(const TREE_DocGia root, int maThe) {
    /*/ Quy tat: di het trai, sau do check node goc, sau do di het phai.
    ...
    while (current != nullptr) {
        if (maThe < current->maThe) {
            ...
            } else return current; // trung thi tra ve.
